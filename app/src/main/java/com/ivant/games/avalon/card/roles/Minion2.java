...
public class Minion2 implements Card, MinionView, MinionVisible, MerlinVisible {

    private String name = "Minion";
    private int imageResource = R.drawable.minion2;
    private static Minion2 instance = new Minion2();
